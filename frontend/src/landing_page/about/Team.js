        ...
        <section className="container py-5">
            ...
            <div className="row align-items-center mb-5 pb-4">
                ...
                <div className="col-12 col-lg-7 px-lg-5">
                    <p className="text-muted lh-lg" style={{ fontSize: "0.98rem" }}>
                    ...
                    <p className="text-muted lh-lg mb-0" style={{ fontSize: "0.98rem" }}>
            ...
            <div className="row g-4">
                {teamMembers.map((member) => (
                    <div className="col-6 col-md-4" key={member.name}>
